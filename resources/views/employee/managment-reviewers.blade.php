@section('title', 'Dashboard - Gestión de Reseñadores')
...
@extends('dashboard-layout.dashboard')
    ...
    @section('sidebar-links')
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('employee.managment-reviewers') }}">Gestión de Reseñadores</a>
        </li>
    ...
    @section('nav-content')
        <h1 class="h2 m-0">Gestión de Reseñadores</h1>
