@section('title', 'Dashboard - Gestión de Reseñas')
...
@extends('dashboard-layout.dashboard')
    ...
    @section('sidebar-links')
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('employee.managment-stories') }}">Gestión de Reseñas</a>
        </li>
        <li class="nav-item">
    ...
    @section('nav-content')
        <h1 class="h2 m-0">Gestión de Reseñas</h1>
